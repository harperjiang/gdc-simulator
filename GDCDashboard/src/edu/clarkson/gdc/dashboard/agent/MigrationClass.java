...
public class MigrationClass {
	...
	private static void executeInShell(String command,String srcIP, String destIP,
			String vmName) throws IOException {
		ProcessBuilder builder = new ProcessBuilder(command,srcIP,destIP,vmName);
...
//		Process p = r.exec("//home//vinay//migrate.sh "+srcIP+ " " +destIP+" "+vmName);
