...
CREATE TABLE `node_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `node_history_search` (`node_id`,`data_type`,`time`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `seq_table` VALUES ('alert',1),('migration_log',1),('node_history',1);
...
-- Dump completed on 2013-08-02 16:11:40
